...
# 🔹 Path Settings
PERF_PATH = "C:/Users/LG_LAB/Desktop/SSELCPP/SHAP_select/CB/curve/cb_performance_by_features.csv"
FEATURE_PATH = "C:/Users/LG_LAB/Desktop/SSELCPP/SHAP_Results/CB/full_train/ranked_features.csv"
SAVE_DIR = "C:/Users/LG_LAB/Desktop/SSELCPP/SHAP_select/CB/curve"
...
# 🔹 Visualization and save performance + LOWESS
...
for i, metric in enumerate(["Accuracy", "ROC_AUC", "MCC"]):
    ...
    plt.title(f"CatBoost LOWESS0.2", fontsize=22)

    # Tick label font size
    plt.xticks(fontsize=18)
    plt.yticks(fontsize=18)

    # Legend position bottom-right, adjust font size
    plt.legend(loc="lower right", fontsize=18)

    plt.grid(True)

plt.tight_layout()
plot_path = os.path.join(SAVE_DIR, "cb_shap_lowess0.2_selection.png")
...
for metric in ["Accuracy", "ROC_AUC", "MCC"]:
    ...
    save_path = os.path.join(SAVE_DIR, f"optimal_features_lowess0.2_cb_{metric.lower()}_{opt_k}.csv")
