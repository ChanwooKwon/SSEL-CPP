...
for i, metric in enumerate(["Accuracy", "ROC_AUC", "MCC"]):
    ...
    plt.title(f"CatBoost LOWESS0.5", fontsize=22)
...
plt.tight_layout()
plot_path = os.path.join(SAVE_DIR, "cb_shap_lowess_selection.png")
...
for metric in ["Accuracy", "ROC_AUC", "MCC"]:
    ...
    save_path = os.path.join(SAVE_DIR, f"optimal_features_lowess_cb_{metric.lower()}_{opt_k}.csv")
