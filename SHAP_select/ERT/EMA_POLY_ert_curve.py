...
# ───── Settings ─────
BASE_DIR = "C:/Users/LG_LAB/Desktop/SSELCPP/SHAP_select/ERT"
PERF_PATH = os.path.join(BASE_DIR, "curve/ert_performance_by_features.csv")
...
plt.tight_layout()
ema_plot_path = os.path.join(BASE_DIR, "ert_shap_ema_selection.png")
plt.savefig(ema_plot_path, dpi=1000)
plt.show()
print(f"EMA plot saved: {ema_plot_path}")

# ───── Save Polynomial-based Plot ─────
plt.figure(figsize=(18, 5))
...
plt.tight_layout()
poly_plot_path = os.path.join(BASE_DIR, "ert_shap_polyfit_selection.png")
