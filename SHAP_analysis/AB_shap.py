...
# ─── Settings ─────────────────────────────────────────────
MODEL_NAME = "AB_1_optuna_best_model"
MODEL_DIR = "C:/Users/LG_LAB/Desktop/SSELCPP/Method4/BestModel/AB"
PARAMS_TXT = "C:/Users/LG_LAB/Desktop/SSELCPP/Method4/AB/AB_1_optuna_best_params.txt"
DATA_PATH = "C:/Users/LG_LAB/Desktop/SSELCPP/Feature/mordred2dfeature_knn.csv"
SAVE_DIR = f"C:/Users/LG_LAB/Desktop/SSELCPP/SHAP_Results/AB"
...
# ─── Load AdaBoost hyperparameters ─────────────────────────────
def load_ab_params(path):
    params = {}
...
best_params = load_ab_params(PARAMS_TXT)
...
for fold, (train_idx, val_idx) in enumerate(tqdm(cv.split(X, y), total=5)):
    ...
    shap_vals = explainer.shap_values(X_sample)[1]
...
# ② Compute averaged SHAP values across folds
...
# ③ Compute SHAP values on the full training set
...
explainer_all = shap.KernelExplainer(model_all.predict_proba, X_sample_all)
shap_vals_all = explainer_all.shap_values(X_sample_all)[1]
