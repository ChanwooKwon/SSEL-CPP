...
PARAMS_TXT_PATH = "./ert_1_ema_best_params.txt"
PROBA_SAVE_PATH = "./ert_1_ema_oof_proba.npy"
LABEL_SAVE_PATH = "./ert_1_ema_labels.npy"
METRIC_TXT_PATH = "./ert_1_ema_metrics.txt"
PLOT_SAVE_PATH = "./ert_1_ema_optimization_history.png"
...
print(" ERT model, OOF predictions, metrics, and visualization saved successfully")
