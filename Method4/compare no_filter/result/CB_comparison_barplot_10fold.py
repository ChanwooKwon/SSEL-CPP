...
before = [0.7824, 0.5652, 0.8657]
after = [0.7824, 0.5656, 0.8656]
p_values = [0.9980, 0.9777, 0.9706]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/CB_filtering_comparison_10fold.png", dpi=300)
plt.show()
