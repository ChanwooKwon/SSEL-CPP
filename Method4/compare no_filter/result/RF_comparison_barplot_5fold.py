...
before = [0.7919, 0.5839, 0.8701]
after = [0.7907, 0.5814, 0.8645]
p_values = [0.8427, 0.8458, 0.1485]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/RF_filtering_comparison_5fold.png", dpi=300)
plt.show()
