...
before = [0.7906, 0.5816, 0.8713]
after = [0.7938, 0.5886, 0.8720]
p_values = [0.6467, 0.6118, 0.8267]
...
plt.ylim(0.5, 0.95)
plt.title('LGB (Before vs After Feature Filtering)')
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/LGB_filtering_comparison_10fold.png", dpi=300)
plt.show()
