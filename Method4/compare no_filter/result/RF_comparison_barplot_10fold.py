...
before = [0.7843, 0.5692, 0.8667]
after = [0.7780, 0.5565, 0.8625]
p_values = [0.2919, 0.2884, 0.1562]
...
plt.ylim(0.5, 0.95)
plt.title('RF (Before vs After Feature Filtering)')
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/RF_filtering_comparison_10fold.png", dpi=300)
plt.show()
