...
before = [0.7805, 0.5623, 0.8650]
after = [0.7786, 0.5581, 0.8654]
p_values = [0.8338, 0.8152, 0.9085]
...
plt.ylim(0.5, 0.95)
plt.title('GB (Before vs After Feature Filtering)')
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/GB_filtering_comparison_10fold.png", dpi=300)
plt.show()
