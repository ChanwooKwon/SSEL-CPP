...
before = [0.7988, 0.5977, 0.8703]
after = [0.7957, 0.5915, 0.8729]
p_values = [0.4981, 0.5023, 0.3008]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/LGB_filtering_comparison_5fold.png", dpi=300)
plt.show()
