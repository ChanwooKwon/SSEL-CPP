...
before = [0.7957, 0.5919, 0.8639]
after = [0.7932, 0.5865, 0.8680]
p_values = [0.8111, 0.7989, 0.2129]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/GB_filtering_comparison_5fold.png", dpi=300)
plt.show()
