...
before = [0.7919, 0.5839, 0.8672]
after = [0.7951, 0.5902, 0.8721]
p_values = [0.7418, 0.7396, 0.0951]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/XGB_filtering_comparison_5fold.png", dpi=300)
plt.show()
