...
before = [0.7830, 0.5667, 0.8639]
after = [0.7761, 0.5536, 0.8679]
p_values = [0.2460, 0.2643, 0.2571]
...
plt.ylim(0.5, 0.95)
plt.title('XGB (Before vs After Feature Filtering)')
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Method4/compare no_filter/boxplot/XGB_filtering_comparison_10fold.png", dpi=300)
plt.show()
