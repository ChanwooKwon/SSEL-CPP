...
after = [0.7799, 0.5605, 0.8658]
p_values = [0.5535, 0.5554, 0.0713]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSCPP/Method4/compare no_filter/boxplot/ERT_filtering_comparison_10fold.png", dpi=300)
plt.show()
