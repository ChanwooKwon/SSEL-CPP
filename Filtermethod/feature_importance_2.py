...
importance_file_path = "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/Featureimportance/feature_importance_2.csv"
...
def compare_kendall(pair):
    ...
    # Keep the feature with the higher tau
...
if __name__ == '__main__':
    ...
    sorted_features = sorted(
        feature_importance,
        key=lambda x: (abs(x[1]) if x[1] is not None else -np.inf),
        reverse=True
    )
