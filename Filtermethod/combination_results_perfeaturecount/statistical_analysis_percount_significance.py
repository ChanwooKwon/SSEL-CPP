...
# ── CSV file paths (manually specified) ─────────────────────────────
file_paths = [
    "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/4x4_rf_combination_results_top50.csv",
    "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/4x4_rf_combination_results_top100.csv",
    "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/4x4_rf_combination_results_top150.csv",
    "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/4x4_rf_combination_results_top200.csv",
    "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/4x4_rf_combination_results_top250.csv",
    "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/4x4_rf_combination_results_top300.csv"
]

# ── Output directory (ensure it exists) ─────────────────────────────
save_dir = "C:/Users/LG_LAB/Desktop/SSELCPP/Filtermethod/combination_results_perfeaturecount/Figure/"
...
for path in file_paths:
    df = pd.read_csv(path)
    feature_count = int(path.split("_top")[-1].split(".")[0])
    ...
    for metric_col, metric_label in metrics.items():
        ...
        save_path = os.path.join(save_dir, f"{metric_label}_Top{feature_count}_with_significance.png")
