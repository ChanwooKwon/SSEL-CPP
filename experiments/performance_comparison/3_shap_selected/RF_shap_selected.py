...
MODEL_SAVE_PATH = SAVE_DIR / "rf_shap_selected_model.pkl"
PARAMS_TXT_PATH = SAVE_DIR / "rf_shap_selected_params.txt"
PROBA_SAVE_PATH = SAVE_DIR / "rf_shap_selected_oof_proba.npy"
LABEL_SAVE_PATH = SAVE_DIR / "rf_shap_selected_labels.npy"
METRIC_TXT_PATH = SAVE_DIR / "rf_shap_selected_metrics.txt"
PLOT_SAVE_PATH = SAVE_DIR / "rf_shap_selected_optimization_history.png"
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("RandomForest SHAP Selected Best Hyperparameters (Optuna)\n")
    f.write("=" * 50 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("RandomForest SHAP Selected CV Metrics\n")
    f.write("=" * 40 + "\n")
...
print(f"✅ RandomForest SHAP Selected training completed!")
