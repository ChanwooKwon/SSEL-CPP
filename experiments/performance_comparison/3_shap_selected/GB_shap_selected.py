...
# ── Path settings ─────────────────────────────────────────────
FEATURE_CSV_PATH = base_dir / "shap_feature_selection" / "feature_optimization" / "GB" / "curve" / "optimal_features_lowess0.3_gb_accuracy_125.csv"
DATA_PATH = base_dir / "data" / "mordred2dfeature_knn.csv"
SAVE_DIR = current_dir / "results"
SAVE_DIR.mkdir(parents=True, exist_ok=True)

MODEL_SAVE_PATH = SAVE_DIR / "gb_shap_selected_model.pkl"
PARAMS_TXT_PATH = SAVE_DIR / "gb_shap_selected_params.txt"
PROBA_SAVE_PATH = SAVE_DIR / "gb_shap_selected_oof_proba.npy"
LABEL_SAVE_PATH = SAVE_DIR / "gb_shap_selected_labels.npy"
METRIC_TXT_PATH = SAVE_DIR / "gb_shap_selected_metrics.txt"
PLOT_SAVE_PATH = SAVE_DIR / "gb_shap_selected_optimization_history.png"
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("GradientBoost SHAP Selected Best Hyperparameters (Optuna)\n")
    f.write("=" * 50 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("GradientBoost SHAP Selected CV Metrics\n")
    f.write("=" * 40 + "\n")
...
print(f"✅ GradientBoost SHAP Selected training completed!")
