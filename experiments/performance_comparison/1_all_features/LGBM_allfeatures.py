...
MODEL_SAVE_PATH = SAVE_DIR / "lgbm_allfeatures_model.pkl"
PARAMS_TXT_PATH = SAVE_DIR / "lgbm_allfeatures_params.txt"
PROBA_SAVE_PATH = SAVE_DIR / "lgbm_allfeatures_oof_proba.npy"
LABEL_SAVE_PATH = SAVE_DIR / "lgbm_allfeatures_labels.npy"
METRIC_TXT_PATH = SAVE_DIR / "lgbm_allfeatures_metrics.txt"
PLOT_SAVE_PATH = SAVE_DIR / "lgbm_allfeatures_optimization_history.png"
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("LightGBM All Features Best Hyperparameters (Optuna)\n")
    f.write("=" * 50 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("LightGBM All Features CV Metrics\n")
    f.write("=" * 40 + "\n")
...
print(f"✅ LightGBM All Features training completed!")
