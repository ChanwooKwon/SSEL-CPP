...
MODEL_SAVE_PATH = SAVE_DIR / "lgb_method4_model.pkl"
PARAMS_TXT_PATH = SAVE_DIR / "lgb_method4_params.txt"
PROBA_SAVE_PATH = SAVE_DIR / "lgb_method4_oof_proba.npy"
LABEL_SAVE_PATH = SAVE_DIR / "lgb_method4_labels.npy"
METRIC_TXT_PATH = SAVE_DIR / "lgb_method4_metrics.txt"
PLOT_SAVE_PATH = SAVE_DIR / "lgb_method4_optimization_history.png"
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("LightGBM FilterMethod4 Best Hyperparameters (Optuna)\n")
    f.write("=" * 50 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("LightGBM FilterMethod4 CV Metrics\n")
    f.write("=" * 40 + "\n")
...
print(f"✅ LightGBM FilterMethod4 training completed!")
