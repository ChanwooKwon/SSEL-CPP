...
output_dir = "C:/Users/LG_LAB/Desktop/SSELCPP/Descriptor analysis_effectsize/BCUTc-1h/"
...
def cliffs_delta(x_cpp, y_noncpp):
    nx, ny = len(x_cpp), len(y_noncpp)
    total = 0
    for xi in x_cpp:
        for yi in y_noncpp:
            if xi > yi:
