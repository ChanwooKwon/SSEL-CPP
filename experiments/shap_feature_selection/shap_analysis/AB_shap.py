...
MODEL_DIR = base_dir / "model_training" / "saved_models" / "AB"
PARAMS_TXT = base_dir / "model_training" / "models" / "AB" / "AB_1_optuna_best_params.txt"
DATA_PATH = base_dir / "data" / "mordred2dfeature_knn.csv"
SAVE_DIR = base_dir / "shap_feature_selection" / "results" / "AB"
