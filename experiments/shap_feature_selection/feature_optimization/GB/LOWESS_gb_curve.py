...
# 🔹 Path Settings
PERF_PATH = current_dir / "curve" / "gb_performance_by_features.csv"
FEATURE_PATH = base_dir / "shap_feature_selection" / "results" / "GB" / "full_train" / "ranked_features.csv"
...
plt.tight_layout()
plot_path = SAVE_DIR / "gb_shap_lowess_selection.png"
...
for metric in ["Accuracy", "ROC_AUC", "MCC"]:
    ...
    save_path = SAVE_DIR / f"optimal_features_lowess_gb_{metric.lower()}_{opt_k}.csv"
