...
for i, metric in enumerate(["Accuracy", "ROC_AUC", "MCC"]):
    ...
    plt.title(f"XGBoost LOWESS0.3", fontsize=22)
...
plt.tight_layout()
plot_path = SAVE_DIR / "xgb_shap_lowess0.3_selection.png"
...
for metric in ["Accuracy", "ROC_AUC", "MCC"]:
    ...
    save_path = SAVE_DIR / f"optimal_features_lowess0.3_xgb_{metric.lower()}_{opt_k}.csv"
