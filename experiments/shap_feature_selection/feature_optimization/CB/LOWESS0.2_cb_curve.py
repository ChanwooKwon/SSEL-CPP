...
# 🔹 Path Settings
PERF_PATH = current_dir / "curve" / "cb_performance_by_features.csv"
FEATURE_PATH = base_dir / "shap_feature_selection" / "results" / "CB" / "full_train" / "ranked_features.csv"
...
plt.tight_layout()
plot_path = SAVE_DIR / "cb_shap_lowess0.2_selection.png"
...
for metric in ["Accuracy", "ROC_AUC", "MCC"]:
    ...
    save_path = SAVE_DIR / f"optimal_features_lowess0.2_cb_{metric.lower()}_{opt_k}.csv"
