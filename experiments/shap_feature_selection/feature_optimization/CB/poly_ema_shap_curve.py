...
RANKED_FEATURES_PATH = base_dir / "shap_feature_selection" / "results" / "CB" / "full_train" / "ranked_features.csv"
SCORE_CSV_PATH = SAVE_DIR / "cb_performance_by_features.csv"
PLOT_PATH = SAVE_DIR / "cb_feature_curve_plot.png"
...
for metric, val in zip([
    ...
    path = SAVE_DIR / f"optimal_features_{metric}_cb_{val}.csv"
