...
PERF_PATH = SAVE_DIR / "cb_performance_by_features.csv"
...
plt.tight_layout()
ema_plot_path = SAVE_DIR / "cb_shap_ema_selection.png"  
...
plt.tight_layout()
poly_plot_path = SAVE_DIR / "cb_shap_polyfit_selection.png"
