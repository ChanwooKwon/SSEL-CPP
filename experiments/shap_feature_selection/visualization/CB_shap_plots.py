...
# ───── Visualization function (same style as AB version) ─────────────────
def save_shap_summary_plots(shap_values, X, feature_names, save_prefix):
    ...
    # Modify colorbar (only label and fontsize, without moving position)
...
# ───── Re-generate fold-based visualizations ─────────────────────────────
for fold in range(5):
    ...
    print(f" Fold {fold} visualization completed")

# ───── Re-generate full train visualization ─────────────────────────────
...
print(" Full train visualization completed")