...
MODEL_SAVE_PATH = base_dir / "model_training" / "saved_models" / "XGB" / "XGB_1_optuna_best_model.pkl"
PARAMS_TXT_PATH = current_dir / "XGB_1_optuna_best_params.txt"

PROBA_SAVE_PATH = current_dir / "XGB_1_optuna_oof_proba.npy"
LABEL_SAVE_PATH = current_dir / "XGB_1_optuna_labels.npy"
METRIC_TXT_PATH = current_dir / "XGB_1_optuna_metrics.txt"
PLOT_SAVE_PATH = current_dir / "XGB_1_optimization_history.png"
...
print("✅ XGBoost model, OOF predictions, and metrics saved successfully.")