...
MODEL_SAVE_PATH = base_dir / "model_training" / "saved_models" / "LGBM" / "LGBM_1_optuna_best_model.pkl"
PARAMS_TXT_PATH = current_dir / "LGBM_1_optuna_best_params.txt"

PROBA_SAVE_PATH = current_dir / "LGBM_1_optuna_oof_proba.npy"
LABEL_SAVE_PATH = current_dir / "LGBM_1_optuna_labels.npy"
METRIC_TXT_PATH = current_dir / "LGBM_1_optuna_metrics.txt"
PLOT_SAVE_PATH = current_dir / "LGBM_1_optimization_history.png"
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("LightGBM Best Hyperparameters (Optuna)\n")
    f.write("=" * 40 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("LightGBM (Optuna Tuned) CV Metrics\n")
    f.write("=" * 40 + "\n")
    for key, val in metrics.items():
        f.write(f"{key}: {val:.4f}\n")

print("✅ LightGBM model, OOF predictions, and metrics saved successfully.")