...
FEATURE_AFTER_PATH = "C:/Users/LG_LAB/Desktop/SSELCPP/SHAP_select/RF/feature/optimal_features_polyfit_rf_acc_152.csv"
RESULT_SAVE_PATH = "./rf_filter_comparison_allss_result_10fold.txt"
...
with open(RESULT_SAVE_PATH, "w") as f:
    f.write("RF 성능 비교 (Feature Filtering 전후, 5-fold CV + Paired t-test)\n")
    f.write("=" * 70 + "\n")
