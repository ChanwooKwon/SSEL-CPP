...
after = [0.7875, 0.5754, 0.8647]
p_values = [0.5637, 0.5831, 0.2263]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/RF_filtering_comparison_5fold.png", dpi=300)
plt.show()
