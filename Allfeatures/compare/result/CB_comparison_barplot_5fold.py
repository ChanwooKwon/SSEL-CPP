...
after = [0.8039, 0.6079, 0.8763]
p_values = [0.3159, 0.3134, 0.0011]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/CB_filtering_comparison_5fold.png", dpi=300)
plt.show()
