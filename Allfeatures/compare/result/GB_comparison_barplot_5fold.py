...
after = [0.8014, 0.6028, 0.8784]
p_values = [0.4753, 0.4985, 0.0029]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/GB_filtering_comparison_5fold.png", dpi=300)
plt.show()
