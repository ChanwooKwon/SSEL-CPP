...
after = [0.7856, 0.5720, 0.8759]
p_values = [0.6824, 0.6614, 0.0832]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/CB_filtering_comparison_10fold.png", dpi=300)
plt.show()
