...
after = [0.7976, 0.5956, 0.8805]
p_values = [0.5282, 0.5305, 0.0265]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/LGB_filtering_comparison_10fold.png", dpi=300)
plt.show()
