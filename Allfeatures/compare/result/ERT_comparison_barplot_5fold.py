...
after = [0.7825, 0.5650, 0.8642]
p_values = [0.1888, 0.1760, 0.0556]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/ERT_filtering_comparison_5fold.png", dpi=300)
plt.show()
