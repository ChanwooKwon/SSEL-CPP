...
after = [0.7780, 0.5567, 0.8627]
p_values = [0.3383, 0.3386, 0.1192]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/RF_filtering_comparison_10fold.png", dpi=300)
plt.show()
