...
after = [0.7969, 0.5945, 0.8819]
p_values = [0.0143, 0.0148, 0.0020]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/XGB_filtering_comparison_10fold.png", dpi=300)
plt.show()
