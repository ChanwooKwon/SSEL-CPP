...
after = [0.7938, 0.5890, 0.8797]
p_values = [0.0156, 0.0152, 0.0003]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/GB_filtering_comparison_10fold.png", dpi=300)
plt.show()
