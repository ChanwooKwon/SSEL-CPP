...
after = [0.8115, 0.6230, 0.8816]
p_values = [0.0984, 0.0981, 0.0253]
...
plt.tight_layout()
plt.savefig("C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/compare/barplot/XGB_filtering_comparison_5fold.png", dpi=300)
plt.show()
