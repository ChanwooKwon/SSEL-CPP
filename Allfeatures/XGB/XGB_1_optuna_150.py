...
MODEL_SAVE_PATH = "./Allfeatures/BestModel/XGB/xgb_1_optuna_best_model_all.pkl"
PARAMS_TXT_PATH = "./Allfeatures/XGB/xgb_1_optuna_best_params_all.txt"
PROBA_SAVE_PATH = "./Allfeatures/OOF_Proba/xgb_1_optuna_oof_proba_all.npy"
LABEL_SAVE_PATH = "./Allfeatures/OOF_Proba/xgb_1_optuna_labels_all.npy"
METRIC_TXT_PATH = "./Allfeatures/XGB/xgb_1_optuna_metrics_all.txt"
PLOT_SAVE_PATH = "C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/XGB/xgb_1_optimization_history_all.png"
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("XGB1 Best Hyperparameters (Optuna, All Features)\n")
    f.write("=" * 40 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("XGBoost (Optuna Tuned, All Features) CV Metrics\n")
    f.write("=" * 40 + "\n")
    for key, val in metrics.items():
        f.write(f"{key}: {val:.4f}\n")

print(" XGBoost model using all features saved successfully")
