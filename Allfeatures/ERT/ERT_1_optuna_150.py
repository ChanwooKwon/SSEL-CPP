...
PARAMS_TXT_PATH = "./Allfeatures/ERT/ert_1_optuna_best_params_all.txt"
MODEL_SAVE_PATH = "./Allfeatures/BestModel/ERT/ert_1_optuna_best_model_all.pkl"
PROBA_SAVE_PATH = "./Allfeatures/OOF_Proba/ert_1_optuna_oof_proba_all.npy"
LABEL_SAVE_PATH = "./Allfeatures/OOF_Proba/ert_1_optuna_labels_all.npy"
METRIC_TXT_PATH = "./Allfeatures/ERT/ert_1_optuna_metrics_all.txt"
PLOT_SAVE_PATH = "C:/Users/LG_LAB/Desktop/SSELCPP/Allfeatures/ERT/ert_1_optimization_history_all.png"
...
# Load data and prepare CV splits
...
with open(PARAMS_TXT_PATH, "w") as f:
    f.write("ERT1 Best Hyperparameters (Optuna)\n")
    f.write("=" * 40 + "\n")
...
with open(METRIC_TXT_PATH, "w") as f:
    f.write("ERT (Optuna Tuned, All Features) CV Metrics\n")
    f.write("=" * 40 + "\n")
    for k, v in metrics.items():
        f.write(f"{k}: {v:.4f}\n")

print(" ERT model (using all features) saved successfully")
